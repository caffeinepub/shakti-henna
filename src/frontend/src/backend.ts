...
export class Backend implements backendInterface {
    ...
    async countProductInterest(): Promise<[bigint, bigint]> {
        if (this.processError) {
            try {
                const result = await this.actor.countProductInterest();
                return [
                    result[0],
                    result[1]
                ];
    ...
    async getInquiriesByCountry(arg0: string): Promise<Array<Inquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getInquiriesByCountry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string, arg3: boolean, arg4: boolean, arg5: string): Promise<void> {
        if (this.processError) {
            try {
